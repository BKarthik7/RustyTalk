...
const USER_MESSAGE_DARK_MODE_COLORS: &str  = "bg-blue-600 text-white";
const USER_MESSAGE_LIGHT_MODE_COLORS: &str  = "bg-blue-500 text-white";
const USER_MESSAGE_CLASS: &str = "max-w-md p-4 mb-5 rounded-lg self-end shadow-md";

const MODEL_MESSAGE_LIGHT_MODE_COLORS: &str = "bg-gray-100 text-gray-800";
const MODEL_MESSAGE_DARK_MODE_COLORS: &str = "bg-gray-700 text-gray-200";
const MODEL_MESSAGE_CLASS: &str = "max-w-md p-4 mb-5 rounded-lg self-start shadow-md";

const CHAT_AREA_CLASS: &str = "h-[calc(100vh-6rem)] pb-24 w-full flex flex-col overflow-y-auto p-5";
const CHAT_AREA_LIGHT_MODE_COLORS: &str = "border-gray-200 bg-gray-50";
const CHAT_AREA_DARK_MODE_COLORS: &str = "border-gray-600 bg-gray-800";
